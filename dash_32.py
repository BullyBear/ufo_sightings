...
app = dash.Dash('dash_32', sharing=True, url_base_pathname='/dash_32', csrf_protect=False, server=server) 

app.config['suppress_callback_exceptions']=True

df = pd.read_csv('app_7/ufo_sightings.csv') 
...
fin = open('app_7/ufo_sightings.csv','r') 
